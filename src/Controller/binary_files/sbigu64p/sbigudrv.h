...
typedef enum 
{
	...
	*/
	...
	CC_CFW_CHILD,					/*!< Control the child filter wheel connected to a dual-wheel setup	*/
...
{ 
	...
	// AFW Filter Wheel Support
	CFWSEL_AFW16,		/*!< AFW filter wheel, 16 slots */
	CFWSEL_AFW15,		/*!< AFW filter wheel, 15 slots */
	CFWSEL_AFW14,		/*!< AFW filter wheel, 14 slots */
	CFWSEL_AFW13,		/*!< AFW filter wheel, 13 slots */
	CFWSEL_AFW12,		/*!< AFW filter wheel, 12 slots */
	CFWSEL_AFW11,		/*!< AFW filter wheel, 11 slots */
	CFWSEL_AFW10,		/*!< AFW filter wheel, 10 slots */
	CFWSEL_AFW9,		/*!< AFW filter wheel,  9 slots */
	CFWSEL_AFW8,		/*!< AFW filter wheel,  8 slots */
	CFWSEL_AFW7,		/*!< AFW filter wheel,  7 slots */
	CFWSEL_AFW6,		/*!< AFW filter wheel,  6 slots */
	CFWSEL_AFW5,		/*!< AFW filter wheel,  5 slots */
	CFWSEL_AFW4,		/*!< AFW filter wheel,  4 slots */
	CFWSEL_AFW3,		/*!< AFW filter wheel,  3 slots */
	CFWSEL_AFW2,		/*!< AFW filter wheel,  2 slots */
} 
CFW_MODEL_SELECT;
